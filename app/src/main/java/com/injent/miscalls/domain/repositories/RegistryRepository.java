...
public class RegistryRepository {
    ...
    public Call<JResponse> sendDocument(Registry registry) {
    ...
    public void deleteRegistry(Function<Throwable,Void> ex, Consumer<Void> consumer, int id) {
        deleteRegistryFuture = CompletableFuture
                .supplyAsync((Supplier<Void>) () -> {
                    ...
                    CallInfo call = callInfoDao.getById(registry.getCallId());
                    call.setInspected(false);
                    callInfoDao.updateCall(call);
                    return null;
                })
                .exceptionally(ex);
